...
const Home = () => {
	...
	return (
		<div className="container text-center">
			<h1 className="container d-flex justify-content-center text-center col-8 bi bi-x-lg">TO DO LIST</h1>
			...
			<div className="container shadow p-1 bg-white rounded col-8 bi bi-x-lg">
				<input type="text" value={inputValue} onChange={(e) => setinputValue(e.target.value)}
					...
					placeholder="Esa puta memoria (Escribe aquí majo)" aria-label="Username"
			...
			<div className="container d-flex justify-content-center text-center mt-4">
				<button type="button" onClick={() => deletelist()} className="btn btn-warning" value>Borrar</button>
			</div>
		</div>
	);
};
